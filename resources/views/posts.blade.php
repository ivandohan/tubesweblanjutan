        ...
        <div class="card-body">
            ...
            <p class="mb-3">
                <small class="text-muted">  
                    By : <a href="/" class="text-decoration-none" >Ucok</a> in <a href="/" class="text-decoration-none">Berita</a>
                </small> 
            </p>

            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae, deleniti.</p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Unde, saepe!</p>
